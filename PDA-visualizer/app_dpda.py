...
import ast
from visualize_dpda import PushDownAutomata as dpda_visualizer  # Import the DPDA visualizer
...
def home():
    if request.method == "POST":
        ...
        dpda = pda.create_dpda(  # Use create_dpda instead of create_npda
            states,
            input_symbols,
            stack_symbols,
            transitions,
        ...
        if pda.validate_dpda(dpda):  # Use validate_dpda instead of validate_npda
        ...
        if test_strings is not None:
            for test_string in test_strings:
                res.append(pda.simulate_dpda(test_string, dpda))  # Use simulate_dpda instead of simulate_npda
